...
export default function CombinedLanding() {
  ...
  const galleryItems: PortfolioItem[] = [
    ...
    },
    {
      ...
      title: "AI 기반 콘텐츠 제작",
      subtitle: "딥러닝 기술 활용",
      description: "AI 도구를 활용한 창의적 콘텐츠 제작 작업입니다. 최신 딥러닝 기술을 통해 독창적인 시각 콘텐츠를 구현했습니다.",
      category: "AI Content",
      year: "2024",
      client: "개인 포트폴리오",
      role: "AI 콘텐츠 크리에이터",
    ...
    },
    {
      ...
      alt: "브랜딩 디자인 프로젝트",
      title: "브랜딩 디자인",
      subtitle: "시각적 아이덴티티 구축",
      description: "기업의 브랜드 아이덴티티 구축을 위한 시각적 디자인 프로젝트입니다. 일관성 있는 브랜드 이미지 구현에 중점을 두었습니다.",
    ...
    {
      id: "gallery-10",
      src: "/attached_assets/image_1754010688370.png",
      alt: "모션 그래픽 작업",
      title: "모션 그래픽",
      subtitle: "동적 시각 콘텐츠",
      description: "브랜드 프로모션을 위한 모션 그래픽 작업입니다. 동적인 요소를 통해 시청자의 몰입도를 높이는 콘텐츠를 제작했습니다.",
    ...
    {
      id: "gallery-11",
      src: "/attached_assets/image_1754010966152.png",
      alt: "UI/UX 디자인",
      title: "UI/UX 디자인",
      subtitle: "사용자 경험 최적화",
      description: "사용자 중심의 인터페이스 디자인 프로젝트입니다. 직관적인 사용자 경험과 시각적 완성도를 동시에 추구했습니다.",
    ...
    {
      id: "gallery-12",
      src: "/attached_assets/image_1754011964166.png",
      alt: "패키지 디자인",
      title: "패키지 디자인",
      subtitle: "제품 포장 디자인",
      description: "제품의 브랜드 가치를 극대화하는 패키지 디자인 작업입니다. 기능성과 심미성을 모두 고려한 포장 솔루션을 제공했습니다.",
      category: "Package Design",
      year: "2024",
      client: "소비재 브랜드",
      role: "패키지 디자이너",
      tools: ["Illustrator", "3D Mockup", "Print Design"],
      images: [],
    },
    {
      id: "gallery-13",
      src: "/attached_assets/Gather_01_1754012619251.png",
      alt: "메타버스 환경 디자인",
      title: "메타버스 환경 디자인",
      subtitle: "가상 공간 설계",
      description: "Gather 기반 메타버스 환경 디자인 작업입니다. 사용자 친화적인 가상 공간을 통해 새로운 소통 경험을 제공합니다.",
      category: "Metaverse Design",
      year: "2024",
      client: "다양한 기업",
      role: "메타버스 디자이너",
      tools: ["Gather", "Pixel Art", "Environment Design"],
      images: [],
    },
    {
      id: "gallery-14",
      ...
      alt: "웹 디자인 프로젝트",
      title: "웹 디자인",
      subtitle: "반응형 웹사이트 디자인",
      description: "모던하고 반응형인 웹사이트 디자인 프로젝트입니다. 사용자 경험을 최우선으로 고려한 웹 인터페이스를 구현했습니다.",
      category: "Web Design",
      year: "2024",
      client: "웹 에이전시",
      role: "웹 디자이너",
    ...
    },
    {
      ...
      alt: "기업 교육 콘텐츠",
      title: "기업 교육 콘텐츠",
      subtitle: "온라인 학습 경험 개선",
      description: "기업 내 온라인 교육 프로그램을 위한 콘텐츠 디자인입니다. 학습 효과를 극대화하는 인터랙티브 콘텐츠를 제작했습니다.",
      category: "Educational Content",
      year: "2024",
      client: "기업 교육 부서",
      role: "교육 콘텐츠 디자이너",
      tools: ["E-learning Tools", "Interactive Design", "Video Production"],
      images: [],
    },
          ...
          <div className="bg-white rounded-xl shadow-2xl relative tracking-tight leading-relaxed overflow-hidden" style={{ width: "90vw", height: "50.625vw", maxWidth: "1440px", maxHeight: "810px", minWidth: "800px", minHeight: "450px" }}>
            <div className="h-full overflow-y-scroll">
              ...
              <div className="px-8 lg:px-16 pb-12">
                ...
                {selectedProject.id === "3" && (
                  <div className="mb-12">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="text-center mb-8">
                        <p className="text-sm text-[#58534e] italic">컴플라이언스 캠페인 콘텐츠 제작 현장</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <div className="space-y-4">
                          ...
                          <p className="text-sm text-[#58534e] leading-relaxed">
                            단순한 수치 분석을 넘어 행동 패턴 뒤에 숨은 심리적 동기를 파악하여 전략적으로 활용하는 것이 저의 차별화된 강점입니다. 사용자들의 회피 패턴을 역이용하여 더 효과적인 메시지 전달 방식을 개발한 이 경험은, 기존의 일방적인 캠페인 방식에서 벗어나 사용자들의 환경까지 고려한 캠페인 기획의 가능성을 보여주었습니다.
                          </p>
                          <p className="text-sm text-[#58534e] leading-relaxed">
                ...
                {/* 메타버스(5번)와 컴플라이언스(3번) 프로젝트는 주요 성과 섹션 생략 - 상세 모달에서 충분히 다뤄짐 */}
                {selectedProject.id !== "5" && selectedProject.id !== "3" && (
                  <div className="mb-12">
