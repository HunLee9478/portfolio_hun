...
export default function CombinedLanding() {
  ...
  const [editableTexts, setEditableTexts] = useState<Record<string, string>>({
    ...
    aboutDescription: "각 개인에게 이야기를, 아이들이 더 큰 꿈을 키울 수 있도록 김혜수, 김연아, 페이커, 필릭스가 참여한 2024년 '유니세프 팀' 캠페인에서 개인적 스토리를 통한 진정한 공감대 형성의 완성형을 보았습니다. 데이터 분석부터 콘텐츠 제작, 실시간 운영까지 전 과정을 아우르는 올인원 캠페인 전문가로서, 형식적 참여를 진정한 소통으로 전환하는 개인 맞춤형 디지털 캠페인을 만들겠습니다.",
    service1Title: "미디어 콘텐츠 기획, 제작",
    service1Description: "기획-연출-촬영-편집-디자인-워크플로우 자동화까지 콘텐츠 제작 전 과정을 통합 수행하는 역량을 갖췄습니다. Python, ComfyUI, Midjourney 등 최신 AI 툴을 활용해 조회수 10만+ 조회 콘텐츠와 평점 5.0 달성으로 창작 의도의 완벽한 구현력을 입증했습니다.",
  ...
  const portfolioItems: PortfolioItem[] = [
    ...
    },
    {
      ...
      client: "Snapask",
      role: "올인원 제작, 프로페셔널 영상, 자동화 시스템",
      tools: ["Video Production", "Brand Content", "Automation System", "In-house Production"],
      images: [
        "/assets/projects/snapask-1.png",
        "/assets/projects/snapask-2.png",
        "/assets/projects/snapask-3.png",
  ...
  const galleryItems: PortfolioItem[] = [
...

    {
      ...
      alt: "사내 캠페인 콘텐츠 제작",
      title: "사내 캠페인 콘텐츠 제작",
      subtitle: "기업 내부 소통 강화 프로젝트",
      description: "기업의 사내 캠페인을 위한 영상 콘텐츠 제작 현장입니다. 임직원들의 참여도를 높이고 기업 문화 개선을 목표로 하는 사내 커뮤니케이션 캠페인 콘텐츠를 기획하고 제작했습니다.",
      category: "Internal Campaign",
      year: "2024",
      client: "현대 글로비스",
      role: "캠페인 기획, 영상 제작",
      tools: ["Campaign Planning", "Video Production", "Internal Communication"],
      images: [],
    },
    {
      id: "gallery-5",
            ...
            <div className={SPACING.sectionGap}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
                ...
                <div className="lg:col-span-6">
                  ...
                  >
                    각 개인에게 이야기를, 아이들이 더 큰 꿈을 키울 수 있도록" 김혜수, 김연아, 페이커, 필릭스가 참여한 2024년 '유니세프 팀' 캠페인에서 개인적 스토리를 통한 진정한 공감대 형성의 완성형을 보았습니다. 데이터 분석부터 콘텐츠 제작, 실시간 운영까지 전 과정을 아우르는 올인원 캠페인 전문가로서, 형식적 참여를 진정한 소통으로 전환하는 개인 맞춤형 디지털 캠페인을 만들겠습니다.
                  </EditableText>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl relative tracking-tight leading-relaxed overflow-hidden" style={{ width: "90vw", height: "50.625vw", maxWidth: "1440px", maxHeight: "810px", minWidth: "800px", minHeight: "450px" }}>
            <div className="h-full overflow-y-scroll">
                  ...
                  <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      {selectedProject.id === "8" && (
                        ...
                        >
                          50회 이상 캠페인에서 NPS 4.5 이상을 달성하고, 출연자 불참이나 시스템 오류 등 돌발 상황에서도 즉석 대응으로 캠페인을 완주했습니다. 본사부터 해외법인까지 다국어 캠페인과 메타버스 플랫폼을 활용한 혁신적 캠페인 운영을 성공적으로 수행했습니다.
                        </AdvancedEditableText>
                      )}
              ...
              <div className="px-8 lg:px-16 pb-12">
                ...
                {/* 7번 프로젝트 상세 콘텐츠 - 삼성물산 컴플라이언스 캠페인 (새 템플릿) */}
                {selectedProject.id === "7" && (
                  <div className="mb-12">
                    {/* 1. 프로젝트 기간 */}
                    <div className="mb-8">
                      ...
                      <div className="mb-6">
                        <span className="text-sm text-gray-800 tracking-tight leading-relaxed">2023.02 ~ 2023.08 (6개월)</span>
                      </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 mb-4">
                        <div className="text-center mb-4">
                          <h4 className="text-sm font-medium text-gray-800">프로젝트 핵심 프로세스</h4>
                        </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="bg-gray-100 rounded-lg p-6 border border-gray-300 mb-6">
                        <div className="text-center mb-6">
                          <div className="inline-flex items-center bg-gray-800 text-white px-4 py-2 rounded-md text-sm font-medium">프로젝트 전체 프로세스</div>
                        </div>
                      ...
                      <div className="space-y-6">
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          ...
                          <div className="p-4 bg-white">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                              <div className="text-center mb-4">
                                <div className="inline-block bg-gray-600 text-white px-4 py-2 rounded-lg font-medium text-sm">뎁스 인터뷰</div>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">뎁스 인터뷰</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">법정 교육에 대한 '의무감'과 '거부감' 사이의 심리적 갈등 구조 파악</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">3개 페르소나 도출</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">적극 참여형, 소극 참여형, 회피형 - 각 유형별 학습 동기와 회피 패턴 분석</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">ALT+TAB 패턴 분석</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">유저시나리오 기반으로 ALT+TAB 사용률 90% 발생 시점과 트리거 요인을 구체적으로 식별</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          <div className="bg-gray-500 text-white p-3">
                            <div className="flex items-center">
                              ...
                              <span className="font-medium">콘텐츠 기획 관점 - 혁신적 포맷 개발</span>
                            </div>
                          </div>
                          <div className="p-4 bg-white">
                            {/* 변환 다이어그램 */}
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                              <div className="text-center mb-4">
                                <h6 className="text-sm font-medium text-gray-800">혁신적 포맷 변환 과정</h6>
                              </div>
                              <div className="flex items-center justify-between">
                                <div className="flex-1 text-center">
                            ...
                            <div className="space-y-4">
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">웹툰형 시각 구성</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">페르소나별 선호 디지털 환경(메신저, 브라우저, 문서)을 활용한 웹툰형 시각 구성으로 기존 강의형 콘텐츠의 한계 극복</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">회피 행동의 학습 효과 전환</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">유저시나리오에서 도출한 화면 전환 순간을 활용하여 임팩트 있는 메시지를 배치, 회피 행동을 학습 효과로 전환하는 구조 설계</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          ...
                          <div className="p-4 bg-white">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                              <div className="text-center mb-4">
                                <h6 className="text-sm font-medium text-gray-800">제작 효율화 성과</h6>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">효율적 제작 시스템</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">고정 화면 중심 연출로 촬영 효율 30% 증대 및 편집 시간 40% 단축하여 한국어, 영어, 중국어, 일본어, 베트남어 5개국어 버전 동시 제작</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h6 className="text-sm font-medium text-gray-800 mb-2">직관적 시각적 학습 환경</h6>
                                <p className="text-sm text-gray-600 leading-relaxed">페르소나 분석을 통해 언어와 상관없이 직관적으로 이해 가능한 시각적 학습 환경 구현</p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="mb-6 mt-8 pt-8 border-t border-gray-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          ...
                          <p className="text-sm text-[#58534e]">Premiere Pro, After Effects, Found Footage 기반 디지털 화면 편집 및 모션 그래픽</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">AI 기술</h5>
                          <p className="text-sm text-[#58534e]">Stable Diffusion, Midjourney를 활용한 시각 자료 및 UI 요소 생성</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">리서치 & 분석</h5>
                          <p className="text-sm text-[#58534e]">User Research, 뎁스 인터뷰, 페르소나 설계를 통한 행동 패턴 분석</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">글로벌 확장</h5>
                          <p className="text-sm text-[#58534e]">다국어 시스템, 고정 화면 구조를 통한 효율적 5개국어 제작</p>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          {(expandedSection === 'content-creation' || expandedSection === 'all') && (
                            <div className="p-4 bg-white space-y-4">
                              ...
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                ...
                                <div className="space-y-4 text-sm mt-6 mb-6">
                                  <div className="bg-white border border-gray-300 rounded-lg p-5">
                                    <p className="text-[#282623] font-medium mb-4">창의적 솔루션 설계</p>
                                    <p className="text-[#58534e] leading-relaxed mb-4">
                                  ...
                                  <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                                    <p className="text-[#282623] font-medium mb-4">핵심 설계 원칙</p>
                                    <div className="ml-3 space-y-2 text-[#58534e] text-sm">
                  ...
                  <div className="mb-12">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                          ...
                          <div className="bg-white rounded-lg p-4 border border-gray-300">
                            ...
                            <div className="text-[#58534e] text-[14px]">제작-운영</div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                              ...
                              <div className="flex items-center justify-between text-center">
                                <div className="bg-red-100 border border-red-300 rounded-lg p-2 flex-1 mx-1">
                                  <div className="font-medium text-red-800 text-[14px]">돌발 상황</div>
                                ...
                                <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-2 flex-1 mx-1">
                                  <div className="font-medium text-yellow-800 text-[14px]">즉시 판단</div>
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div className="text-center">
                                  <div className="bg-blue-100 border-2 border-blue-300 rounded-lg p-3 mb-2">
                                    ...
                                    <div className="text-blue-600 mt-1 text-[14px]">진행자 역할</div>
                                  </div>
                    ...
                    <div className="mb-8 mt-8 pt-8 border-t border-gray-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-4">다국어 소통</h5>
                          <p className="text-sm text-[#58534e]">통역 협업, 글로벌 커뮤니케이션 지원</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-4">기술 통합</h5>
                          <p className="text-sm text-[#58534e]">송출 시스템, 그래픽 제작, 벤더 커뮤니케이션 통합 관리</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-4">역할 전환</h5>
                ...
                {selectedProject.id === "9" && (
                  <div className="mb-12">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="bg-gray-100 rounded-lg p-6 border border-gray-300 mb-6">
                        <div className="text-center mb-6">
                          <div className="inline-flex items-center bg-[#282623] text-white px-4 py-2 rounded-md text-sm font-medium">문제해결 사이클</div>
                        </div>
                      ...
                      <div className="space-y-6">
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          <div className="bg-[#6b7280] text-white p-3">
                            <div className="flex items-center">
                              <span className="w-6 h-6 bg-white text-[#6b7280] rounded-full flex items-center justify-center text-sm font-bold mr-3">1</span>
                              <span className="font-medium">올인원 제작 관점 - 전체 프로세스 통합 관리</span>
                            </div>
                          </div>
                          <div className="p-4 bg-white">
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                              <h6 className="text-sm font-medium text-[#282623] mb-3">전 과정 통합 체인</h6>
                              <div className="flex items-center justify-between text-center">
                                <div className="flex-1">
                            ...
                            <div className="space-y-3">
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">기획·연출·촬영·조명·미술(스튜디오 제작) 전 과정을 직접 수행하여 외주업체 간 소통 단절과 의사결정 지연 문제 해결</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">창작 의도부터 최종 결과물까지 일관된 품질 관리로 프리미엄 브랜드 콘텐츠에 적합한 완성도 확보</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          <div className="bg-[#6b7280] text-white p-3">
                            <div className="flex items-center">
                              <span className="w-6 h-6 bg-white text-[#6b7280] rounded-full flex items-center justify-center text-sm font-bold mr-3">2</span>
                              <span className="font-medium">프로페셔널 영상 제작 관점 - 고품질 구현</span>
                            </div>
                          </div>
                          <div className="p-4 bg-white space-y-4">
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                              <h6 className="text-sm font-medium text-[#282623] mb-2">영화급 장비 시스템</h6>
                              <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">영화 제작용 전문 카메라와 조명 시스템을 직접 구축하여 기존 브랜드 영상 대비 시각적 품질 대폭 향상</p>
                            </div>
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                              <h6 className="text-sm font-medium text-[#282623] mb-2">브랜드 색감 표준화</h6>
                              <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">브랜드 전용 색감 표준을 개발하고 전문 색보정 소프트웨어로 모든 영상에 일관된 고급스러운 톤 적용</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          <div className="bg-[#6b7280] text-white p-3">
                            <div className="flex items-center">
                              <span className="w-6 h-6 bg-white text-[#6b7280] rounded-full flex items-center justify-center text-sm font-bold mr-3">3</span>
                              <span className="font-medium">대량 제작 자동화 관점 - 효율성 극대화</span>
                            </div>
                          </div>
                          <div className="p-4 bg-white">
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-4">
                            ...
                            <div className="space-y-3">
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">프로그래밍을 활용한 자막 생성과 음성 인식 검수 시스템으로 반복 작업 90% 감소</p>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <p className="text-sm text-[#58534e] tracking-tight leading-relaxed">확장 가능한 제작 체계 구축으로 대량 콘텐츠 동시 처리 능력 확보</p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">영상 제작</h5>
                          <p className="text-sm text-[#58534e]">색보정 소프트웨어, Premiere Pro, After Effects를 활용한 브랜드 표준 고급 편집</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">그래픽 리소스</h5>
                          <p className="text-sm text-[#58534e]">Photoshop, AI 이미지 도구를 활용한 브랜드 그래픽 및 창의적 자료 제작</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">자동화 시스템</h5>
                          <p className="text-sm text-[#58534e]">Python 스크립팅, 음성 인식 API, 배치 처리를 통한 자막 자동화 및 대량 렌더링</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <h5 className="text-sm font-bold text-[#282623] mb-2">영화급 장비</h5>
                          <p className="text-sm text-[#58534e]">전문 촬영 장비를 활용한 고품질 영상 제작</p>
                        </div>
                      </div>
                    </div>
                  </div>
