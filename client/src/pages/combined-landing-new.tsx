          ...
          <div className="bg-white rounded-xl shadow-2xl relative tracking-tight leading-relaxed overflow-hidden" style={{ width: "90vw", height: "50.625vw", maxWidth: "1440px", maxHeight: "810px", minWidth: "800px", minHeight: "450px" }}>
            <div className="h-full overflow-y-scroll">
              ...
              <div className="px-8 lg:px-16 pb-12">
                ...
                {/* 3번 프로젝트 - 컴플라이언스 캠페인 전용 상세 모달 */}
                {selectedProject.id === "3" && (
                  <div className="mb-12">
                    {/* 프로젝트 개요 */}
                    <div className="mb-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200">
                      <h3 className="text-base text-[#282623] font-bold mb-4 tracking-tight leading-relaxed">
                        삼성물산 컴플라이언스 캠페인 콘텐츠 기획·제작
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white rounded-lg p-4 border border-gray-300">
                          <div className="text-xs text-[#6b7280] mb-1 font-medium">프로젝트 기간</div>
                          <div className="text-sm text-[#282623] font-bold">2023.02 ~ 2023.08 (6개월)</div>
                        </div>
                        <div className="bg-white rounded-lg p-4 border border-gray-300">
                          <div className="text-xs text-[#6b7280] mb-1 font-medium">핵심 혁신</div>
                          <div className="text-sm text-[#282623] font-bold">ALT+TAB 회피 패턴 역이용</div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-3">
                            ...
                            <div className="text-sm font-bold text-[#282623]">비즈니스 성과</div>
                          </div>
                          <div className="text-xs text-[#58534e] leading-relaxed">
                            경쟁사 대비 30% 높은 단가로 수주 성공
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-3">
                            ...
                            <div className="text-sm font-bold text-[#282623]">혁신적 접근</div>
                          </div>
                          <div className="text-xs text-[#58534e] leading-relaxed">
                            사용자 화면 전환 회피 행동을 역이용한 메신저·브라우저 기반 콘텐츠 포맷 개발
                          </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-3">
                            ...
                            <div className="text-sm font-bold text-[#282623]">글로벌 확장</div>
                          </div>
                          <div className="text-xs text-[#58534e] leading-relaxed">
                            고정 화면 중심 연출로 촬영 효율 30% 증대 및 편집 시간 40% 단축으로 5개국어 다국어 콘텐츠 개발
                          </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                          <h4 className="text-sm font-bold text-[#282623] mb-2 flex items-center">
                            <span className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs mr-2">1</span>
                            사용자 중심 분석
                          </h4>
                          <p className="text-xs text-[#58534e] leading-relaxed">
                            뎁스 인터뷰, 페르소나, 유저시나리오를 통해 ALT+TAB 화면 전환 패턴의 심리적 저항 원인을 발견하고 이를 활용한 역발상 전략 수립
                          </p>
                        </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-4">
                            ...
                            <h4 className="text-sm font-bold text-[#282623]">사용자 리서치 관점 - 행동 패턴 심층 분석</h4>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">1</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">20명 대상 뎁스 인터뷰를 통해 법정 교육에 대한 '의무감'과 '거부감' 사이의 심리적 갈등 구조 파악</div>
                            </div>
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">2</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">3개 페르소나(적극 참여형, 소극 참여형, 회피형) 도출 및 각 유형별 학습 동기와 회피 패턴 분석</div>
                            </div>
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">3</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">유저시나리오 기반으로 ALT+TAB 사용률 90% 발생 시점과 트리거 요인을 구체적으로 식별</div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-4">
                            ...
                            <h4 className="text-sm font-bold text-[#282623]">콘텐츠 기획 관점 - 혁신적 포맷 개발</h4>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-green-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">1</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">페르소나별 선호 디지털 환경(메신저, 브라우저, 문서)을 활용한 웹툰형 시각 구성으로 기존 강의형 콘텐츠의 한계 극복</div>
                            </div>
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-green-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">2</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">유저시나리오에서 도출한 화면 전환 순간을 활용하여 임팩트 있는 메시지를 배치, 회피 행동을 학습 효과로 전환하는 구조 설계</div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                          <div className="flex items-center mb-4">
                            ...
                            <h4 className="text-sm font-bold text-[#282623]">제작 효율화 관점 - 글로벌 확장 전략</h4>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-purple-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">1</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">고정 화면 중심 연출로 촬영 효율 30% 증대 및 편집 시간 40% 단축하여 한국어, 영어, 중국어, 일본어, 베트남어 5개국어 버전 동시 제작</div>
                            </div>
                            <div className="flex items-start">
                              <div className="w-4 h-4 bg-purple-500 rounded-full flex items-center justify-center text-white text-xs mr-3 mt-0.5 flex-shrink-0">2</div>
                              <div className="text-xs text-[#58534e] leading-relaxed">페르소나 분석을 통해 언어와 상관없이 직관적으로 이해 가능한 시각적 학습 환경 구현</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                          <div className="flex items-center mb-2">
                            ...
                            <h5 className="text-sm font-bold text-[#282623]">영상 제작</h5>
                          </div>
                          <p className="text-xs text-[#58534e]">Premiere Pro, After Effects를 활용한 디지털 화면 기반 포맷 및 모션 그래픽 제작</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-4 border border-yellow-200">
                          <div className="flex items-center mb-2">
                            ...
                            <h5 className="text-sm font-bold text-[#282623]">그래픽 리소스</h5>
                          </div>
                          <p className="text-xs text-[#58534e]">Photoshop, Stable Diffusion, Midjourney로 UI 기반 화면 요소 및 시각 자료 생성</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                          <div className="flex items-center mb-2">
                            ...
                            <h5 className="text-sm font-bold text-[#282623]">사용자 리서치</h5>
                          </div>
                          <p className="text-xs text-[#58534e]">뎁스 인터뷰, 페르소나 설계, 유저시나리오 분석을 통한 사용자 중심 콘텐츠 기획</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                          <div className="flex items-center mb-2">
                            ...
                            <h5 className="text-sm font-bold text-[#282623]">다국어 최적화</h5>
                          </div>
                          <p className="text-xs text-[#58534e]">고정 화면 구조를 활용한 효율적 다국어 버전 제작 시스템 구축</p>
                        </div>
                      </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="bg-gradient-to-r from-gray-50 to-white rounded-lg p-6 border border-gray-200 shadow-sm">
                        <div className="space-y-4">
                          <div className="flex items-start">
                          ...
                          <div className="flex items-start">
                            ...
                            <p className="text-sm text-[#58534e] leading-relaxed">
                              유니세프에서는 후원자들의 진정한 관심사와 감정적 동기를 데이터로 읽어내어, 아동권리가 '해야 할 일'이 아닌 '자연스럽게 하게 된 일'이 될 수 있는 개인의 숨겨진 마음과 환경까지 고려한 캠페인을 설계하겠습니다.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {/* 메타버스(5번), 컴플라이언스(3번), 삼성물산 컴플라이언스(6번) 프로젝트는 주요 성과 섹션 생략 - 상세 모달에서 충분히 다뤄짐 */}
                {selectedProject.id !== "5" && selectedProject.id !== "3" && selectedProject.id !== "6" && (
                  <div className="mb-12">
